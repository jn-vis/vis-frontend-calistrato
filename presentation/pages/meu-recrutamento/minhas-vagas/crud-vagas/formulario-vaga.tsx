...
import useFiltroRequisitosStore from '../store/filtro-requisitos-store';
...
const FormularioVaga: React.FC<FormularioVagaProps> = ({ vagaId }) => {
    ...
    const {isRemoto,isPresencial,isHibrido,isPcd,isClt,isPj,isBtc,estados,estadoSelecionadoId,setRemoto, setHibrido, setPresencial, setClt, setPj, setBtc, setEstadoSelecionadoId} = useFiltroCandidatoStore()
