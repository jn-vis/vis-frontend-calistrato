const Footer = () => {
    return (
            <footer className="flex flex-row w-ful justify-center py-6 px-5">
            ...
            <div className="p-6 pt-0 mt-auto text-center dark:text-white-dark ltr:sm:text-left rtl:sm:text-right">Um pouco sobre nós</div>
